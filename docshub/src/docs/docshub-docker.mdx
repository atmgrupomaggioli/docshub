...
<Alert type="warning">
  Make sure to **initialize the workspace before attempting to run DocsHub with Docker**. For proper functionality, the entire workspace structure should be present in the directory where you intend to run it. You can easily generate this workspace using the [**DocsHub CLI**](/docshub-cli)!
</Alert>
